        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold text-white">ResumeToJobs</span>
              </div>
              <p className="text-sm text-neutral-400 leading-relaxed max-w-md mb-6">
                Professional job application service. We handle resume tailoring, cover letters, and job submissions so you can focus on landing the offer. Zero commission, full transparency.
              </p>
              <div className="flex items-center gap-4">
                <a
                  href="https://api.whatsapp.com/send/?phone=919493063818&text=Hi+I%27d+like+to+know+more+about+ResumeToJobs&type=phone_number&app_absent=0"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-neutral-800 hover:bg-[#25D366] rounded-lg flex items-center justify-center transition-all duration-300 group"
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link href="/tools" className="text-sm text-neutral-400 hover:text-white transition-colors">Free Tools</Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a
                    href="https://api.whatsapp.com/send/?phone=919493063818&text=Hi+I+need+help+with+ResumeToJobs&type=phone_number&app_absent=0"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-sm text-neutral-400 hover:text-white transition-colors"
                  >
          ...
          <div className="mt-12 pt-8 border-t border-neutral-800 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-xs text-neutral-500">
              © {new Date().getFullYear()} ResumeToJobs. All rights reserved. Your data is never sold or shared.
            </p>
            <div className="flex items-center gap-6">
              ...
              <span className="text-xs text-neutral-500">0% Commission</span>
              <span className="text-neutral-700">•</span>
              <span className="text-xs text-neutral-500">US-Based Service</span>
            </div>
          </div>
        </div>
      </footer>
